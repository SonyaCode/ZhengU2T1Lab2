public class ChatBot {
    ...
    // method that talks about hobby
    public void hobby(String favHobby) {
        System.out.println(favHobby + " is such a cool hobby!");
        System.out.println("My hobby is talking!");
        System.out.println("After all, I am a ChatBot.");
    }

    // method that multiply 2 numbers together
